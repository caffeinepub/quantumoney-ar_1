            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="luxury-glass-card p-6 border border-primary/20">
                ...
                <p className="text-muted-foreground text-sm">
                  ...
                  <a href="/map" className="text-primary hover:underline">quantumoney.app/map</a>.
                  Capture moedas QMY no mundo real usando a mesma identidade e carteira.
                </p>
              </div>
              ...
              <div className="luxury-glass-card p-6 border border-primary/20">
                ...
                <p className="text-muted-foreground text-sm">
                  ...
                  é usado em todas as secções: perfil, carteira, jogo e governança.
                </p>
              </div>
              ...
              <div className="luxury-glass-card p-6 border border-primary/20">
                ...
                <p className="text-muted-foreground text-sm">
                  ...
                  Não existem bases de dados paralelas ou fontes de dados locais.
                </p>
              </div>
            </div>
          </section>
